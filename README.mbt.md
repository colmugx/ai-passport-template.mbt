...
```sh
moonx colmugx/ai-passport/cmd/passport@0.1.1 dev
```
...
rule(
  ...
  command: "moonx colmugx/ai-passport/cmd/passport@0.1.1 generate-sounds $input $output",
)
...
```sh
moonx colmugx/ai-passport/cmd/passport@0.1.1 doctor --host web
moonx colmugx/ai-passport/cmd/passport@0.1.1 build --host web
```
