...
No ADC hardware is emulated: the BSP driver itself stays in the submodule.
"""
...
COMPONENT = REPO_ROOT / "device" / "esp32c3" / "components" / "button_bridge"

# Faithful shims of the exact surface button_bridge.c consumes. The BSP
# signatures mirror external/folotoy-ai-passport's components/bsp/include/
